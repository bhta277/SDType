...
public class ComputeBaseStatistics {
	public void computeGlobalTypeDistribution() {
		...
		String insertWhole = "INSERT INTO stat_resource SELECT distinct resource FROM (SELECT subject AS resource FROM dbpedia_properties UNION SELECT object AS resource FROM dbpedia_properties) as resource";
		try {
